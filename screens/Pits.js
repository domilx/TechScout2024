      ...
      >
        ...
        <View style={styles.subViews}>
          <TextInput
            ...
            onChangeText={(text) =>
              setNewPitData({ ...newPitData, teamName: text })
            }
          />
        </View>
        ...
        <View style={styles.subViews}>
          ...
          <TextInput
            ...
            onChangeText={(text) =>
              setNewPitData({ ...newPitData, ScoutNotes: text.toString() })
            }
          />
        </View>
        ...
        <View style={styles.subViews}>
          ...
          <DropDownPicker
            ...
            setItems={setType}
            onChangeValue={(DriveType) =>
              setNewPitData({ ...newPitData, DriveType: DriveType })
            }
          />
          {/* Drive base type selection */}
          <DropDownPicker
            ...
            setItems={setMotor}
            onChangeValue={(DriveMotor) =>
              setNewPitData({ ...newPitData, DriveMotors: DriveMotor })
            }
          />
          ...
          <DropDownPicker
            ...
            onChangeValue={(DriverExperience) =>
              setNewPitData({
                ...newPitData,
